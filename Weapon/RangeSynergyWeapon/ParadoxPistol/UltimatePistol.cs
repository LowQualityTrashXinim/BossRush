            ...
            else
            {
                ...
                if (Counter == 10)
                {
                    ...
                    for (int i = 0; i < NumOfProjectile; i++)
                    {
                        ...
                        velocity = RandomSpread(RotateCode(20, i),0,7) * SpeedMultiplier;
