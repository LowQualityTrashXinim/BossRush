...
{
    internal class IronKatana : ModItem
    {
        int counter = 0;
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("isn't this just normal sword in shape of katana ?");
        }
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<IronSlash>();
            ...
            if (player.direction == 1)
            {
                switch (counter)
                {
                    case 0:
                        ...
                        Projectile.NewProjectile(source, getPos1, safeAim1, type, damage, knockback, player.whoAmI);
                        break;
                    case 1:
                        ...
                        Projectile.NewProjectile(source, getPos2, safeAim2, type, damage, knockback, player.whoAmI);
                        break;
                    case 2:
                        ...
                        Projectile.NewProjectile(source, getPos3, safeAim3, type, damage, knockback, player.whoAmI);
                        break;
                }
            }
            else
