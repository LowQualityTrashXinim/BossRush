...
//{
//    internal class WeaponModificationUI : UIState
//    {
//        private BaseItemSlotHolder _vanillaItemSlot;

//        public override void OnInitialize()
//        {
//            _vanillaItemSlot = new BaseItemSlotHolder(ItemSlot.Context.BankItem, 0.85f)
//            {
//                Left = { Pixels = 50 },
//                Top = { Pixels = 270 },
...
//                ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, new ReLogic.Graphics.DynamicSpriteFont(), costText, new Vector2(slotX + 50, slotY), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, Vector2.Zero, Vector2.One, -1f, 2f);
...
//                    if (!tickPlayed)
//                    {
//                        SoundEngine.PlaySound(new SoundStyle() { SoundID.MenuTick, -1, -1, 1, 1f, 0f });
//                    }
//                    tickPlayed = true;
