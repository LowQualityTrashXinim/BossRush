...
namespace BossRush.Contents.UI
{
    internal class BossRushAchievementButton : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(ModContent.Request<Texture2D>("BossRush/icon")); // Frame of our resource bar
            barFrame.Left.Set(0, 0f);
            barFrame.Top.Set(0, 0f);
            barFrame.Width.Set(80, 0f);
            barFrame.Height.Set(80, 0f);

            text = new UIText("Mod Achievement", 0.8f); // text to show stat
    ...
    class ExampleResourseUISystem : ModSystem
    {
        ...
        internal BossRushAchievementButton ExampleResourceBar;
